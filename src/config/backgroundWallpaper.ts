...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/desktop.avif",
		...
		mobile: [
			"assets/images/MobileWallpaper/phone.avif",
		],
		// 背景视频播放地址
		...
		homeText: {
			...
			links: [
				...
				},
				{
					...
					url: "https://blog.pr1tea.org/sponsor/",
				},
				{
					name: "RSS",
					icon: "fa7-solid:rss",
